 ...
 * @author Lenovo
 */
public class ParentsDashboard02 extends javax.swing.JFrame {

    /**
     * Creates new form ParentsDashboard02
     */
    public ParentsDashboard02() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select a test to view marks & Remarks");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParentsDashboard02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParentsDashboard02().setVisible(true);
            }
        });
    }
